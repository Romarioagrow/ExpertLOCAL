...
public class ProductResolver {
        ...
        for (Product product : products)
        {
            try
            {
                if (product.getProductGroup() == null)
                {
                    ...
                    matchProduct("08.01"														    , "Готовые ПК"								, "Готовый ПК"						, "Компьютеры и оргтехника"		, product);
                    ...
                    matchProduct("09.01.01, Сотовые телефоны"										, "Сотовые телефоны"						, "Сотовый телефон"					, "Цифровые устройства"			, product);
                    ...
                    matchProduct("03.07, 03.08, Швейные машины"									, "Швейные машины"							, "Швейная машина"					, "Техника для дома"			    , product);
                    matchProduct("03.03.02, 03.03.03, 03.03.04, Отпариватели"						, "Отпариватели"							, "Отпариватель"						, "Техника для дома"			    , product);
                    matchProduct("03.01.02, Сушильные барабаны"						            , "Сушильные барабаны"						, "Сушильный барабан"					, "Техника для дома"			    , product);
                    ...
                    matchProduct("15.15.02, Кастрюли"											    , "Кастрюли"								, "Кастрюля"							, "Кухонная техника"			    , product);
                    matchProduct("01.04, Посудомоечные машины"									    , "Посудомоечные машины"					, "Посудомоечная машина"				, "Кухонная техника"			    , product);
                    matchProduct("07.05.01, 07.05.02, 07.05.03, 07.05.05, 07.05.05 "				, "Вытяжки"					                , "Вытяжка"				            , "Кухонная техника"			    , product);
                    ...
                    matchProduct("07.03, 07.04, Встраиваемые варочные поверхности"	                , "Встраиваемые варочные панели"			, "Встраиваемая варочная панель"		, "Встраиваемая техника"		    , product);
                    matchProduct("07.05.04_Вытяжки встраиваемые"									, "Встраиваемые вытяжки"					, "Встраиваемая вытяжка"				, "Встраиваемая техника"		    , product);
                    ...
                    matchProduct("15.02.17.01, 15.02.18.01, Цифровая тв приставка, TV-тюнер"	    , "Ресиверы для тв"							, "Цифровой ресивер"					, "Теле-Видео-Аудио"			    , product);
                    ...
                    matchProduct("15.02.17.02, 15.02.17.02, Комнатные антенны"			            , "Антенны ТВ"								, "ТВ антенна"						, "Теле-Видео-Аудио"			    , product);
    ...
    private void matchProduct(String alias, String productGroup, String single, String productCategory, Product product)
    {
        ...
        //System.out.println();
        //log.info(Arrays.toString(matches));

        for (String match : matches)
        {
            //log.info("Alias: " + match);
