...
<@c.page>
    <div class="filters-container marker1">
        ...
        <div class="all-filters">
            <strong class="filter-name ml-30"><span>Фильтры для встраиваемой кухонной техники</span></strong>
    ...
    <div class="products-container marker1">
        <div>
            <h3 class="ml-20 marker2"><span>Встраиваемая кухонная техника</span></h3>
