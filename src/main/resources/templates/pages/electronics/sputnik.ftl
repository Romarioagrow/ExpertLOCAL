...
<@c.page>
    <div class="filters-container marker1">
        ...
        <div class="all-filters">
            <strong class="filter-name ml-30"><span>Фильтры спутниковой технки</span></strong>
    ...
    <div class="products-container marker1">
        <div>
            <h3 class="ml-20 marker2"><span>Какая спутниковая техника вас интересует?</span></h3>
